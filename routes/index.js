...
router.get('/admin/:id', [checkJWT, checkRole(['admin'])], userControllers.getAdmin)
...
router.get('/teachers', [checkJWT, checkRole(['admin'])], userControllers.getAllTeachers)
router.get('/students', [checkJWT, checkRole(['admin'])], userControllers.getAllStudents)
...
router.post(
  '/oralexam/:id/submit',
  [checkJWT, checkRole(['student'])],
  oralExamControllers.oralExamSubmit
)
// get the oral exam correction form
router.get(
  '/oralexam/:id',
  [checkJWT, checkRole(['teacher'])],
  oralExamControllers.oralExamCorrection_form_get
)
// get all the oral exams that needs to be corrected by the teacher
router.get(
  '/oralexams',
  [checkJWT, checkRole(['teacher'])],
  oralExamControllers.oralExamList
)
// oral exam corrections form the teacher
router.post(
  '/oralexam/:id',
  [checkJWT, checkRole(['teacher'])],
  oralExamControllers.oralExamSubmitCorrection_post
)
